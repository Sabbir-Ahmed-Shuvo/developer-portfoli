    ...
    return (
        <div className=" animateStyle">
            ...
            <div className="text-white d-flex justify-content-center mt-5 icons">
                <a href="https://www.facebook.com/sabbir.cse/" target="-blank"><FontAwesomeIcon icon={faFacebook} /></a>
                <a href="https://www.linkedin.com/in/sabbir-ahmed9/" target="-blank"><FontAwesomeIcon className="mx-5" icon={faLinkedinIn} /></a>
                <a href="https://github.com/sabbirNew" target="-blank"><FontAwesomeIcon icon={faGithub} /></a>
