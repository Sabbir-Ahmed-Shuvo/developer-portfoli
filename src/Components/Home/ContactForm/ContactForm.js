            ...
            <div className="row pt-5">
                ...
                <div className="col-md-6 text-white">
                    ...
                    <div className="text-white d-flex justify-content-center mt-5 icons">
                        <a href="https://www.facebook.com/sabbir.cse/"><FontAwesomeIcon icon={faFacebook} /></a>
                        <a href="https://www.linkedin.com/in/sabbir-ahmed9/"><FontAwesomeIcon className="mx-3" icon={faLinkedinIn} /></a>
                        <a href="https://github.com/sabbirNew"><FontAwesomeIcon icon={faGithub} /></a>
