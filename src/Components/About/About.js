                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 col-md-7">
                                            <div className="about-info mt-3">
                                                <p><span className="title-s">Name: </span> <span className="title-v">Sabbir Ahmed</span></p>
                                                <p><span className="title-s">Email: </span> <span className="title-v">sabbir.ahmed5936@gmail.com</span></p>
                                                <p><span className="title-s">Profile: </span> <span className="title-v">Front-End Developer</span></p>

                                                <p><span className="title-s">Phone: </span> <span className="title-v">+8801908054336</span></p>
                                            </div>
                                        </div>
                                    </div>
